...
import type { DiaryEntry, RelationEntry, WorldAgent } from '../api/types';
  ...
  return (
    <main className={styles.workspace}>
      ...
      <section className={styles.detailPane}>
        {selected ? (
          <AgentCardView worldId={worldId} agentId={selected} onClose={() => setSelectedId(null)} />
        ) : (
      ...
      <aside className={styles.contextPane}>
        {selected ? (
          <CharacterContext worldId={worldId} agentId={selected} />
        ) : (
...
function CharacterContext({ worldId, agentId }: { worldId: string; agentId: string }) {
