...
RunListResult RuntimeService::list_runs(const std::string&session_id,const std::string&status,int limit,int offset)const{return store_->list_runs(session_id,status,limit,offset);}
