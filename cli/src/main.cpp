...
static int run_server(int argc,char**argv) {
    ...
    RuntimeMetadata metadata{cfg.llm.provider,cfg.llm.default_model,tools->all_tools(),mcp_status,runtime->agents()};
