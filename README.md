...
<p align="center">
  ...
  面向长篇小说、角色构建与世界观创作的本地优先 AI Agent 工作台。
</p>
...
<p align="center">
  ...
  <img alt="Windows" src="https://img.shields.io/badge/Windows-TUI%20%2B%20WebUI%20%2B%20Desktop-0078D4?style=flat-square" />
  <img alt="Linux" src="https://img.shields.io/badge/Linux-TUI%20%2B%20Server-FCC624?style=flat-square" />
...
| 平台 | TUI | WebUI | Desktop | 说明 |
|---|---:|---:|---:|---|
| Windows | Yes | Yes | Yes | 当前推荐平台，支持终端、浏览器工作台和 Tauri 桌面壳。 |
| Linux | Yes | Experimental | No | 服务端和 TUI 可用；WebUI 可自行运行，但不是当前重点支持目标。 |
| macOS | Not declared | Not declared | Not declared | 当前未声明支持。 |
...
| TUI | `merak tui` | 终端中的对话、worldbuilding 和创作命令入口。 |
...
flowchart TB
  subgraph Clients["Clients"]
    ...
    WebUI["WebUI<br/>Browser"]
    Desktop["Tauri Desktop<br/>Windows package"]
  end
...
也可以用辅助脚本启动 PostgreSQL、写入本地配置、构建并启动服务端：
